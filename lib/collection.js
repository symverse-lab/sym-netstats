...
Collection.prototype.setWarrant = function(id, stats, callback)
{
	var node = this.getNode({ id: id });
	if (!node)
	{
...
Collection.prototype.updatetpsstatus = function(id, tpsstatus, callback)
{
	var node = this.getNode({ id: id });
	...
	{
		node.setTpsStatus(tpsstatus, callback);
	}
}
